...
unittest-default: .venv
	@echo "==> Running tests..."
	@PYTHONPATH=. .venv/bin/pytest . --cov-report term-missing:skip-covered --cov $(CODE_LOCATIONS) --no-cov-on-fail --cov-fail-under=$(COVERAGE_LIMIT) -W ignore::DeprecationWarning
