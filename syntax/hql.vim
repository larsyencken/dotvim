...
syn keyword sqlKeyword  unix_timestamp to_date year month day hour second
syn keyword sqlKeyword  weekofyear datediff date_add from_unixtime
syn keyword sqlKeyword  instr parse_url concat format serde
syn keyword sqlKeyword  location stored rcfile
...
syn keyword sqlStatement truncate update cast as external table from left
syn keyword sqlStatement right join outer inner where is

syn keyword sqlType	boolean char character date float integer long
syn keyword sqlType	mlslabel number raw rowid varchar varchar2 varray
syn keyword sqlType     bigint int timestamp string
